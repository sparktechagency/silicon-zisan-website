...
//       <Container className="py-16 px-5 md:px-0">
...
//           </p>
//           <div className="flex space-x-4 mt-7 md:mt-0">
  ...
  return (
    <footer className={`${gradientClasses.primaryBg} text-white`}>
      <Container className="py-16 px-6 md:px-0">
        ...
        {/* Copyright and Social Media Icons */}
        <div className="mt-8 pt-7 border-t border-white border-opacity-30 flex flex-col md:flex-row items-center justify-between ">
            ...
            {socialLinks?.map((social) => (
              ...
              >
                <button
                  ...
                  className={`${gradientClasses.buttonBg} cursor-pointer w-10 h-10 rounded-full text-white flex items-center justify-center shadow-lg transition-colors`}
                >
                  <span className="sr-only">{social.name}</span>
                  <SocialIcon name={social.icon} />
                </button>
