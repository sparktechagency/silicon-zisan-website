  ...
  return (
    <footer className={`${gradientClasses.primaryBg} text-white`}>
      <Container className="py-16 px-5">
        ...
        <div className="mt-8 pt-8 border-t border-teal-400 border-opacity-30 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-200 text-sm">
            Copyright © {currentYear} JonsinApp
          </p>
